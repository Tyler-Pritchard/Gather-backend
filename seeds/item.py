item = [
...

    {
        ...
        "price": 750,
        "description": "Bacon, Egg & Cheese on English Muffin",
        "addons": [{
            "name": "sub brioche",
            "price": 150
        }],
    ...
    {
        "name": "Turkey, Egg & Cheese",
        "price": 850,
        "description": "on Brioche Bun",
        "addons": [{
            "name": "bacon",
            "price": 150
        }],
...

    {
        "name": "Scramble",
        "price": 800,
        "description": "3 Eggs w/ Cherry Tomato, Garlic, Arugula, Cheddar Cheese",
        "addons": [{
            "name": "bacon",
            "price": 150
        }],
...

    {
        "name": "Peariyaki BLT",
        "price": 1350,
        "description": "Periyaki Bacon, Charred Scallion Aioli, Pear Slaw, Mixed Greens on Toasted Wheat",
        "image_url": 'https://unsplash.it/500/400?random',
        "menu_id": 2
    },
...

    {
        "name": "Pear Salad",
        "price": 1150,
        "description": "Arugula, Shaved Brussel Sprouts, Carrot, Golden Beets, Dried Cranberries, Toasted Pistachio w/ Cilantro Pear",
        "addons": [
            {
...

    {
        "name": "Classic",
        "price": 900,
        "description": "Greens, Cheddar Cheese, Cherry Tomatoes w/ Italian Dressing",
        "addons": [
            {
                "name": "Roasted Chicken",
                "price": 250
